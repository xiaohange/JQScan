...
@interface JQScanNative()<AVCaptureMetadataOutputObjectsDelegate>
{
...
//扫码结果
@property (nonatomic, strong) NSMutableArray<JQScanResult*> *arrayResult;
 ...
 *  扫码结果返回
 */
@property(nonatomic,copy)void (^blockScanResult)(NSArray<JQScanResult*> *array);



@end

@implementation JQScanNative
...
- (id)initWithPreView:(UIView*)preView ObjectType:(NSArray*)objType cropRect:(CGRect)cropRect success:(void(^)(NSArray<JQScanResult*> *array))block
{
    if (self = [super init]) {
...
- (void)initParaWithPreView:(UIView*)videoPreView ObjectType:(NSArray*)objType cropRect:(CGRect)cropRect success:(void(^)(NSArray<JQScanResult*> *array))block
{
    ...
    [[self stillImageOutput] captureStillImageAsynchronouslyFromConnection:stillImageConnection
                                                         completionHandler:^(CMSampleBufferRef imageDataSampleBuffer, NSError *error)
     {
         ...
         if (imageDataSampleBuffer)
         {
             ...
             if (_blockScanResult)
             {
                 for (JQScanResult* result in _arrayResult) {
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    for(AVMetadataObject *current in metadataObjects)
    {
        if ([current isKindOfClass:[AVMetadataMachineReadableCodeObject class]] )
        {
            ...
            JQScanResult *result = [JQScanResult new];
